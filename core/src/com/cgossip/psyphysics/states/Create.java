...
import static com.cgossip.psyphysics.handlers.B2DVars.PPM;
...
// BodyDef and FixtureDef don't need disposing, but shapes do.
		...
		*/
		...
		b2dCam.setToOrtho(false, com.cgossip.psyphysics.main.Game.V_WIDTH / PPM, com.cgossip.psyphysics.main.Game.V_HEIGHT / PPM);
		sb = new SpriteBatch();
...
/*
	...
	void CreateJason()throws Exception {
		...
		FileWriter file = new FileWriter(String.valueOf(Gdx.files.internal("json/level12.json")));
