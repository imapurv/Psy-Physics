package com.cgossip.psyphysics.view;
 ...
 */
public class ExitDialog extends com.cgossip.psyphysics.GdxTest {
    ...
    public void create () {
        ...
        com.badlogic.gdx.scenes.scene2d.ui.Button buttonMulti = new TextButton("Multi\nLine\nToggle", skin, "toggle");
        com.badlogic.gdx.scenes.scene2d.ui.Button imgButton = new com.badlogic.gdx.scenes.scene2d.ui.Button(new Image(image), skin);
        com.badlogic.gdx.scenes.scene2d.ui.Button imgToggleButton = new com.badlogic.gdx.scenes.scene2d.ui.Button(new Image(image), skin, "toggle");
